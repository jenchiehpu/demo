...
const QuerySection = (props) => {
  ...
  const [showJob, setJobBool] = useState(false);  
  ...
  useEffect(() => {
    if (master.type === "job" && master.action === "add") {
      setShowBool(true);
    } else if (showBool) {
      setShowBool(false);
    }
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          {showBool && (
            <>
              <div>
                <span style={{ padding: "0 10px" }}>isSnapshot</span>
                <Dropdown
                  style={dropdownStyle}
                  name="isBool"
                  value={master.isBool}
          ...
          {showJob && (
            <>
          <div>
            <span style={{ padding: "0 10px" }}>輸入JOB NAME</span>
            <input
              style={inputStyle}
              type="text"
              name="dbName"
              value={master.jobname}
          ...
          <div>
            <span style={{ padding: "0 10px" }}>輸入DB NAME</span>
            <input
              style={inputStyle}
              type="text"
              name="dbName"
